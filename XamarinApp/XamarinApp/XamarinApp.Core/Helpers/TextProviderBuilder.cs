...
namespace XamarinApp.Core.Helpers
{
    public class TextProviderBuilder : MvxTextProviderBuilder
    {
        public TextProviderBuilder() : base("XamarinApp.Core", "Resources/Translations", new MvxEmbeddedJsonDictionaryTextProvider(false))
        {
        }
